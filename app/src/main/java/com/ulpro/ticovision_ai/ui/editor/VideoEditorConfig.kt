...
/**
 * Constantes centrales del editor.
 */
object VideoEditorConfig {
    const val EXTRA_PROJECT_ID = "extra_project_id"
    const val INVALID_PROJECT_ID = -1L
    const val AUTO_SAVE_INTERVAL_MS = 3_000L
    ...
    const val TIMELINE_VIDEO_FRAME_WIDTH_DP = 56
}
